...
//!
//! Config home is `$CLAUDE_CONFIG_DIR` (if set) else `~/.claude`. Every
//! function degrades gracefully — a missing directory, unreadable file, or
//! malformed line yields an empty result rather than an error.
//!
//! ## Example
//!
//! ```no_run
